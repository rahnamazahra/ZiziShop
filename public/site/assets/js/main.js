...
(function ($) {
	...
	$('#mobile-menu').meanmenu({
		...
		meanScreenWidth: "991",
		meanExpand: ['<i class="fa-regular fa-angle-left"></i>'],
	});
	...
	if($('.tp-category-menu-content').length && $('.tp-category-mobile-menu').length){
		...
		arrow.each(function () {
			...
			arrowBtn.innerHTML = "<i class='fa-regular fa-angle-left'></i>";
	...
	function tp_ecommerce() {
		...
		$("#slider-range-offcanvas").slider({
			...
			values: [75, 300],
			slide: function (event, ui) {
				$("#amount-offcanvas").val(ui.values[0] + "تومان" + ui.values[1] + " - تومان");
			}
		});
		$("#amount-offcanvas").val($("#slider-range-offcanvas").slider("values", 0) + " تومان - " 
			 + $("#slider-range-offcanvas").slider("values", 1)  + " تومان ");
