                ...
                <div class="tp-header-top-right tp-header-top-black d-flex align-items-center justify-content-end">
                    <div class="tp-header-top-menu d-flex align-items-center justify-content-end">
                        <div class="tp-header-top-menu-item tp-header-setting">
                            ...
                            <li>
                                <a href="{{ url('favorite-products') }}">لیست علاقه مندیها</a>
                            </li>
                            <li>
                            ...
                            <ul>
                                ...
                                <a href="shop.html" class="has-mega-menu">
                                    ...
                                    <ul class="mega-menu tp-submenu">
                                        <li>
                                        <a href="shop.html" class="mega-menu-title">ویژه</a>
                                        <ul>
                                            <li>
                                                <a href="shop.html"><img src="assets/img/header/menu/menu-1.jpg" alt=""></a>
                                            </li>
                                            <li>
                                                <a href="shop.html">موارد جدید</a>
                                            </li>
                                            <li>
                                                <a href="shop.html">پرفروش‌ترین</a>
                                            </li>
                                            <li>
                                                <a href="shop.html">برترین رتبه</a>
                                            </li>
                                        </ul>
                                        </li>

                                        <li>
                                        <a href="shop.html" class="mega-menu-title">کامپیوتر و لپ‌تاپ</a>
                                        <ul>
                                            <li>
                                            <a href="shop.html"><img src="assets/img/header/menu/menu-2.jpg" alt=""></a>
                                            </li>
                                            <li>
                                                <a href="shop.html">برندهای برتر</a>
                                            </li>
                                            <li>
                                                <a href="shop.html">پرفروش‌ترین هفته</a>
                                            </li>
                                            <li>
                                                <a href="shop.html">پربازدیدترین</a>
                                            </li>
                                        </ul>
                                        </li>
                                        <li>
                                        <a href="shop.html" class="mega-menu-title">لوازم جانبی</a>
                                        <ul>
                                            <li>
                                            <a href="shop.html"><img src="assets/img/header/menu/menu-3.jpg" alt=""></a>
                                            </li>
                                            <li>
                                                <a href="shop.html">هدفون</a>
                                            </li>
                                            <li>
                                                <a href="shop.html">گوشی TWS</a>
                                            </li>
                                            <li>
                                                <a href="shop.html">هدست بازی</a>
                                            </li>
                                        </ul>
                                        </li>
                                ...
                                <a href="shop.html">
                                    ...
                                    <ul class="tp-submenu">
                                        <li class="has-dropdown">
                                        <a href="shop.html">رومیزی</a>
                                        <ul class="tp-submenu">
                                            <li><a href="shop.html">بازی</a></li>
                                            <li><a href="shop.html">فضای کاری</a></li>
                                            <li><a href="shop.html">سفارشی کردن</a></li>
                                            <li><a href="shop.html">لوکس</a></li>
                                        </ul>
                                        </li>
                                        <li><a href="shop.html">لپ تاپ</a></li>
                                        <li><a href="shop.html">کنسول</a></li>
                                        <li><a href="shop.html">برترین رتبه</a></li>
                                    </ul>
                                </li>
                                <li>
                                <a href="shop.html">
                ...
                <div class="col-xl-5 col-lg-7 col-md-7 col-sm-8 col-6">
                    <div class="tp-header-bottom-right d-flex align-items-center justify-content-end pr-30">
                        ...
                        <div class="tp-header-action d-flex align-items-center mr-30">
                            ...
                            <a href="{{ url('favorite-products') }}" class="tp-header-action-btn">
