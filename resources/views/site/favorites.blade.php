               ...
               <div class="row">
                  <div class="col-xxl-12">
                     <div class="breadcrumb__content p-relative z-index-1">
                        <h3 class="breadcrumb__title">علاقمندی ها</h3>
                           ...
                           <tbody>
                            @forelse($favorites as $favorite)
                                <tr>
                                 ...
                                 <!-- title -->
                                 <td class="tp-cart-title"><a href="product-details.html">زنانه افسانه ای</a></td>
                                 <!-- price -->
                                 <td class="tp-cart-price"><span>76 تومان</span></td>
                                 <!-- quantity -->
                                 ...
                                 <td class="tp-cart-add-to-cart">
                                    <button type="submit" class="tp-btn tp-btn-2 tp-btn-blue">افزودن به سبد خرید</button>
                                 </td>
                            ...
                            @endforelse
                                <tr>
                                    <td colspan="5" class="text-center">آیتمی برای نمایش وجود ندارد.</td>
                                </tr>
