                  ...
                  <div class="col-xl-9 col-lg-8">
                     <div class="tp-shop-main-wrapper">
                                        ...
                                        <div class="tp-product-item-2 mb-40">
                                            ...
                                            <div class="tp-product-content-2 pt-15">
                                                ...
                                                <div class="tp-product-price-wrapper-2">
                                                    @if($product->discount)
                                                        <span class="tp-product-price-2 new-price">{{ $product->price_with_discount }}</span>
                                                        <span class="tp-product-price-2 old-price">{{ $product->price_label }}</span>
                                                    @else
                                                        <span class="tp-product-price-2 new-price">{{ $product->price_label }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                          ...
                                          <div class="tp-product-list-item d-md-flex">
                                                ...
                                                <div class="tp-product-action-2 tp-product-action-blackStyle">
                                                   <div class="tp-product-action-item-2 d-flex flex-column">
                                                      ...
                                                      <button type="button" class="tp-product-action-btn-2 tp-product-add-to-compare-btn">
                                                         ...
                                                         <span class="tp-product-tooltip tp-product-tooltip-right">افزودن برای مقایسه</span>
                                                      </button>
                                                   </div>
                                                </div>
                                             </div>
                                             <div class="tp-product-list-content">
                                                <div class="tp-product-content-2 pt-15">
                                                   ...
                                                   <div class="tp-product-price-wrapper-2">
                                                      <span class="tp-product-price-2 new-price">82 تومان</span>
                                                      <span class="tp-product-price-2 old-price">99 تومان</span>
                                                   </div>
                                                   <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است</p>
                                                   <div class="tp-product-list-add-to-cart">
                                                      <button class="tp-product-list-add-to-cart-btn">به سبد خرید اضافه کنید</button>
                                                   </div>
                                                </div>
                                             </div>
                                          </div>
                                          <div class="tp-product-list-item d-md-flex">
                                             ...
                                             <div class="tp-product-list-content">
                                                <div class="tp-product-content-2 pt-15">
                                                   ...
                                                   <div class="tp-product-price-wrapper-2">
                                                      <span class="tp-product-price-2 new-price">126 تومان</span>
                                                      <span class="tp-product-price-2 old-price">216 تومان</span>
                                                   </div>
                                                   <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است</p>
                                                   <div class="tp-product-list-add-to-cart">
                                                      <button class="tp-product-list-add-to-cart-btn">به سبد خرید اضافه کنید</button>
                                             ...
                                             <div class="tp-product-list-content">
                                                <div class="tp-product-content-2 pt-15">
                                                   <div class="tp-product-tag-2">
                                                    ...
                                                    <h3 class="tp-product-title-2">
                                                       <a href="product-details.html">کیف چرمی مشکی</a>
                                                   </h3>
                                                   <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                                      <span><i class="fa-solid fa-star"></i></span>
                                                      <span><i class="fa-solid fa-star"></i></span>
                                             ...
                                             <div class="tp-product-list-content">
                                                <div class="tp-product-content-2 pt-15">
                                                   <div class="tp-product-tag-2">
                                                    ...
                                                    <h3 class="tp-product-title-2">
                                                       <a href="product-details.html">مردانه افسانه ای.</a>
                                                   </h3>
                                                   <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                                      <span><i class="fa-solid fa-star"></i></span>
                                                      <span><i class="fa-solid fa-star"></i></span>
                                             ...
                                             <div class="tp-product-list-content">
                                                <div class="tp-product-content-2 pt-15">
                                                   <div class="tp-product-tag-2">
                                                    ...
                                                    <h3 class="tp-product-title-2">
                                                       <a href="product-details.html">پیراهن مردانه آستین کامل</a>
                                                   </h3>
                                                   <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                                      <span><i class="fa-solid fa-star"></i></span>
                                                      <span><i class="fa-solid fa-star"></i></span>
                        ...
                        <div class="infinite-pagination d-none">
                           <a href="shop.html" class="infinite-next-link">بعدی</a>
                        </div>
                  ...
                  <div class="tp-product-modal-content d-lg-flex align-items-start">
                     ...
                     <div class="tp-product-details-wrapper">
                        ...
                        <div class="tp-product-details-inventory d-flex align-items-center mb-10">
                         ...
                         <p>صفحه‌ای که همه دوست خواهند داشت: چه خانواده شما در حال پخش جریانی باشند و چه با دوستان رایانه لوحی A8 گپ ویدیویی... <span>اطلاعات بیشتر</span></p>
