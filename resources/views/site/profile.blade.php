                     ...
                     <div class="profile__tab mr-40">
                        <nav>
                           <div class="nav nav-tabs tp-tab-menu flex-column" id="profile-tab" role="tablist">
                              <button class="nav-link active" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false"><span><i class="fa-regular fa-user-pen"></i></span>پروفایل</button>
                              <button class="nav-link" id="nav-information-tab" data-bs-toggle="tab" data-bs-target="#nav-information" type="button" role="tab" aria-controls="nav-information" aria-selected="false"><span><i class="fa-regular fa-circle-info"></i></span> مشخصات</button>
                              <button class="nav-link" id="nav-address-tab" data-bs-toggle="tab" data-bs-target="#nav-address" type="button" role="tab" aria-controls="nav-address" aria-selected="false"><span><i class="fa-light fa-location-dot"></i></span> آدرس </button>
                              <button class="nav-link" id="nav-order-tab" data-bs-toggle="tab" data-bs-target="#nav-order" type="button" role="tab" aria-controls="nav-order" aria-selected="false"><span><i class="fa-light fa-clipboard-list-check"></i></span> سفارشات من </button>
                              <button class="nav-link" id="nav-notification-tab" data-bs-toggle="tab" data-bs-target="#nav-notification" type="button" role="tab" aria-controls="nav-notification" aria-selected="false"><span><i class="fa-regular fa-bell"></i></span> اعلانات</button>
                              <button class="nav-link" id="nav-password-tab" data-bs-toggle="tab" data-bs-target="#nav-password" type="button" role="tab" aria-controls="nav-password" aria-selected="false"><span><i class="fa-regular fa-lock"></i></span> تغییر رمز ورود</button>
                        ...
                        <div class="tab-content" id="profile-tabContent">
                                       ...
                                       <div class="col-md-6">
                                          <div class="profile__main-inner d-flex flex-wrap align-items-center">
                                             ...
                                             <div class="profile__main-content">
                                                <h4 class="profile__main-title">آقای مدیر خوش آمدید!</h4>
                                                <p>شما <span>08</span> اعلان دارید</p>
                                             </div>
                                          </div>
                                       </div>
                                       <div class="col-md-6">
                                    ...
                                    <div class="row gx-3">
                                       <div class="col-md-3 col-sm-6">
                                          <div class="profile__main-info-item">
                                             ...
                                             <h4 class="profile__main-info-title">دانلودها</h4>
                                          </div>
                                       </div>
                                       <div class="col-md-3 col-sm-6">
                                          <div class="profile__main-info-item">
                                             ...
                                             <h4 class="profile__main-info-title">سفارشات</h4>
                                          </div>
                                       </div>
                                       <div class="col-md-3 col-sm-6">
                                          <div class="profile__main-info-item">
                                             ...
                                             <h4 class="profile__main-info-title">علاقه مندی</h4>
                                          </div>
                                       </div>
                                       <div class="col-md-3 col-sm-6">
                                          <div class="profile__main-info-item">
                                             ...
                                             <h4 class="profile__main-info-title">جعبه هدیه</h4>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                           ...
                           <div class="tab-pane fade" id="nav-information" role="tabpanel" aria-labelledby="nav-information-tab">
                              <div class="profile__info">
                                 <h3 class="profile__info-title">جزئیات شخصی</h3>
                                    ...
                                    <form action="#">
                                       <div class="row">
                                          <div class="col-xxl-6 col-md-6">
                                             <div class="profile__input-box">
                                                <div class="profile__input">
                                                   <input type="text" placeholder="Enter your username" value="شانیوز سالکی">
                                                   <span>
                                          ...
                                          <div class="col-xxl-6 col-md-6">
                                             <div class="profile__input-box">
                                                <div class="profile__input">
                                                   <input type="text" placeholder="Enter username" value="شانیوز سالکی">
                                                   <span>
                                          ...
                                          <div class="col-xxl-6 col-md-6">
                                             <div class="profile__input-box">
                                                <div class="profile__input">
                                                   <input type="text" placeholder="Enter your number" value="7894651230">
                                                   <span>
                                          ...
                                          <div class="col-xxl-12">
                                             <div class="profile__input-box">
                                                <div class="profile__input">
                                                   <input type="text" placeholder="Enter your address" value="ایران - تهران">
                                                   <span>
                                          ...
                                          <div class="col-xxl-12">
                                             <div class="profile__input-box">
                                                <div class="profile__input">
                                                   <textarea placeholder="Enter your bio">سلام، این بیوگرافی من است...</textarea>
                                                </div>
                                             </div>
                                          </div>
                                          <div class="col-xxl-12">
                                             <div class="profile__btn">
                                                <button type="submit" class="tp-btn">به‌روزرسانی نمایه</button>
                                             </div>
                                          </div>
                                       </div>
                                    </form>
                                       ...
                                       <div class="col-xxl-12">
                                          <div class="tp-profile-input-box">
                                             ...
                                             <div class="tp-profile-input-title">
                                                <label for="old_pass">گذرواژه قدیمی</label>
                                              </div>
                                           </div>
                                        </div>
                                        <div class="col-xxl-6 col-md-6">
                                        ...
                                        <div class="col-xxl-6 col-md-6">
                                           <div class="tp-profile-input-box">
                                              ...
                                              <div class="tp-profile-input-title">
                                                 <label for="con_new_pass">تأیید رمز عبور</label>
                                              </div>
                                           </div>
                                        </div>
                                        <div class="col-xxl-6 col-md-6">
                                           <div class="profile__btn">
                                              <button type="submit" class="tp-btn">به‌روزرسانی</button>
                                          </div>
                                       </div>
                                    </div>
                                 </form>
                                    ...
                                    <div class="col-md-6">
                                       <div class="profile__address-item d-sm-flex align-items-start">
                                          ...
                                          <div class="profile__address-content">
                                             <h3 class="profile__address-title">آدرس صورتحساب</h3>
                                             <p><span>خیابان:</span>خیابان گلن 3576</p>
                                             <p><span>شهر:</span>سایه تابستانی</p>
                                             <p><span>ایالت/استان/منطقه:</span>کنتاکی</p>
                                             <p><span>شماره تلفن:</span>270-428-8378</p>
                                             <p><span>کد پستی:</span>42166</p>
                                             <p><span>کد تماس کشور:</span> 1+</p>
                                             <p><span>کشور:</span>ایالات متحده</p>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                       <div class="profile__address-item d-sm-flex align-items-start">
                                          ...
                                          <div class="profile__address-content">
                                             <h3 class="profile__address-title">آدرس حمل و نقل</h3>
                                             <p><span>خیابان:</span>3133 خیابان لوئیس</p>
                                             <p><span>شهر:</span>ناپرویل</p>
                                             <p><span>ایالت/استان/منطقه:</span>ایلینوی</p>
                                             <p><span>شماره تلفن:</span>630-857-9127</p>
                                             <p><span>کد پستی:</span> 60563</p>
                                             <p><span>کد تماس کشور:</span>+1</p>
                                             <p><span>کشور:</span>ایالات متحده</p>
                                          </div>
                                       </div>
                                    ...
                                    <thead>
                                     ...
                                     <tbody>
                                        <tr>
                                           ...
                                           <td data-info="title">چگونه می توانم به اشتراک بگذارم؟</td>
                                           <td data-info="status pending">در انتظار </td>
                                           <td><a href="#" class="tp-logout-btn">فاکتور</a></td>
                                        </tr>
                                        <tr>
                                           <th scope="row"> #2220</th>
                                           <td data-info="title">پول ارسال کنید، اما کار نمی کند</td>
                                           <td data-info="status reply">به پخش مجدد شما نیاز دارم</td>
                                           <td><a href="#" class="tp-logout-btn">پاسخ</a></td>
                                        </tr>
                                        <tr>
                                           <th scope="row"> #2125</th>
                                           <td data-info="title">خطای موجودی</td>
                                           <td data-info="status done">حل شد</td>
                                           <td><a href="#" class="tp-logout-btn">فاکتور</a></td>
                                        </tr>
                                        <tr>
                                           <th scope="row"> #2124</th>
                                           <td data-info="title">نحوه رد پیشنهاد</td>
                                           <td data-info="status hold">در حالت انتظار</td>
                                           <td><a href="#" class="tp-logout-btn">وضعیت</a></td>
                                        </tr>
                                        <tr>
                                           <th scope="row"> #2121</th>
                                           <td data-info="title">نحوه تماس</td>
                                           <td data-info="status done">حل شد</td>
                                           <td><a href="#" class="tp-logout-btn">فاکتور</a></td>
                                       </tr>
                                    </tbody>
                           ...
                           <div class="tab-pane fade" id="nav-notification" role="tabpanel" aria-labelledby="nav-notification-tab">
                              <div class="profile__notification">
                                 <div class="profile__notification-top mb-30">
                                    <h3 class="profile__notification-title">تنظیمات فعالیت من</h3>
                                 ...
                                 <div class="profile__notification-wrapper">
                                    <div class="profile__notification-item mb-20">
                                       <div class="form-check form-switch d-flex align-items-center">
                                          ...
                                          <label class="form-check-label" for="like">اعلان‌های پسندیدن و دنبال کردن</label>
                                        </div>
                                     </div>
                                     <div class="profile__notification-item mb-20">
                                        <div class="form-check form-switch d-flex align-items-center">
                                           <input class="form-check-input" type="checkbox" role="switch" id="post" checked>
                                           <label class="form-check-label" for="post">اعلان‌های پست، نظرات و پاسخ‌ها</label>
                                        </div>
                                     </div>
                                     <div class="profile__notification-item mb-20">
                                        <div class="form-check form-switch d-flex align-items-center">
                                           <input class="form-check-input" type="checkbox" role="switch" id="new" checked>
                                           <label class="form-check-label" for="new">اعلان‌های محصول جدید</label>
                                        </div>
                                     </div>
                                     <div class="profile__notification-item mb-20">
                                        <div class="form-check form-switch d-flex align-items-center">
                                           <input class="form-check-input" type="checkbox" role="switch" id="sale" checked>
                                           <label class="form-check-label" for="sale">اعلان‌های محصول در حال فروش</label>
                                        </div>
                                     </div>
                                     <div class="profile__notification-item mb-20">
                                        <div class="form-check form-switch d-flex align-items-center">
                                           <input class="form-check-input" type="checkbox" role="switch" id="payment" checked>
                                           <label class="form-check-label" for="payment">اعلان‌های پرداخت</label>
                                       </div>
                                    </div>
                                 </div>
                              </div>
