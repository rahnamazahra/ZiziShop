                     ...
                     <div class="breadcrumb__content p-relative z-index-1">
                        <div class="breadcrumb__list has-icon">
                           ...
                           <span><a href="#">صفحه اصلی</a></span>
                            <span><a href="#">الکترونیک</a></span>
                            <span><a href="#">رایانه‌ها و رایانه‌های لوحی</a></span>
                            <span>تبلت Samsung galaxy A7</span>
                         </div>
                     </div>
                  </div>
               </div>
                     ...
                     <div class="col-xl-5 col-lg-6">
                        <div class="tp-product-details-wrapper">
                           <div class="tp-product-details-category">
                            ...
                            <h3 class="tp-product-details-title">تبلت Samsung galaxy A8</h3>
                           ...
                           <div class="tp-product-details-msg mb-15">
                              <ul>
                                 <li>30 روز بازگشت آسان</li>
                                 <li>قبل از ساعت 2:30 بعدازظهر برای ارسال همان روز مال خود را سفارش دهید</li>
                              </ul>
                           </div>
                           <div class="tp-product-details-payment d-flex align-items-center flex-wrap justify-content-between">
                              <p>ایمن تضمین شده <br> و تسویه حساب ایمن</p>
                        ...
                        <div class="tp-product-details-tab-nav tp-tab">
                           <nav>
                              <div class="nav nav-tabs justify-content-center p-relative tp-product-tab" id="navPresentationTab" role="tablist">
                                 ...
                                 <button class="nav-link" id="nav-review-tab" data-bs-toggle="tab" data-bs-target="#nav-review" type="button" role="tab" aria -controls="nav-review" aria-selected="false">نظرات (2)</button>
                                    ...
                                    <div class="row justify-content-center">
                                       <div class="col-xl-10">
                                          <جدول>
                                             <tbody>
                                                <tr>
                                                   <td>اندازه صفحه نمایش ایستاده</td>
                                                   <td>اندازه صفحه نمایش 10.4</td>
                                                </tr>
                                                <tr>
                                                   <td>رنگ</td>
                                                   <td>خاکستری، خاکستری تیره، مشکی عرفانی</td>
                                                </tr>
                                                <tr>
                                                   <td>رزولوشن صفحه</td>
                                                   <td>1920 x 1200 پیکسل</td>
                                                </tr>
                                                <tr>
                                                   <td>حداکثر وضوح صفحه</td>
                                                   <td>2000 x 1200</td>
                                                </tr>
                                                <tr>
                                                   <td>پردازنده</td>
                                                   <td>2.3 گیگاهرتز (128 گیگابایت)</td>
                                                </tr>
                                                <tr>
                                                   <td>همپردازنده گرافیک</td>
                                                   <td>Exynos 9611، هشت هسته ای (4x2.3GHz + 4x1.7GHz)</td>
                                                </tr>
                                                <tr>
                                                   <td>نوع بی سیم</td>
                                                   <td>802.11a/b/g/n/ac، بلوتوث</td>
                                                </tr>
                                                <tr>
                                                   <td>متوسط عمر باتری (به ساعت)</td>
                                                   <td>13 ساعت</td>
                                                </tr>
                                                <tr>
                                                   <td>سری</td>
                                                   <td>برگه Samsung Galaxy S6 Lite WiFi</td>
                                                </tr>
                                                <tr>
                                                   <td>شماره مدل مورد</td>
                                                   <td>SM-P6102ZAEXOR</td>
                                                </tr>
                                                <tr>
                                                   <td>پلتفرم سخت افزار</td>
                                                   <td>اندروید</td>
                                                </tr>
                                                <tr>
                                                   <td>سیستم عامل</td>
                                                ...
                                                <tr>
                                                   <td>باتری</td>
                                                   <td>1 باتری لیتیوم پلیمر مورد نیاز است. (شامل)</td>
                                                </tr>
                                                <tr>
                                                   <td>ابعاد محصول</td>
                                                   <td>0.28 x 6.07 x 9.63 اینچ</td>
                                                </tr>
                                             </tbody>
                                          </table>
                                       </div>
                                             ...
                                             <div class="tp-product-details-review-list pl-110">
                                                ...
                                                <div class="tp-product-details-review-avater d-flex align-items-start">
                                                   ...
                                                   <div class="tp-product-details-review-avater-content">
                                                      ...
                                                      <h3 class="tp-product-details-review-avater-title">شهنواز سکیل</h3>
                                                      <span class="tp-product-details-review-avater-meta">06 شهریور 1402 </span>

                                                      <div class="tp-product-details-review-avater-comment">
                                                         <p>طراحی شده بسیار شبیه به Galaxy tab S6 با قیمت تقریباً دو برابر، و تنها حذف آن است.</p>
                                                      </div>
                                                   </div>
                                                </div>
                                                <div class="tp-product-details-review-avater d-flex align-items-start">
                                                   ...
                                                   <div class="tp-product-details-review-avater-content">
                                                      ...
                                                      <div class="tp-product-details-review-avater-comment">
                                                         <p>این بررسی برای Samsung Tab S6 Lite، وای فای 64 گیگابایتی به رنگ آبی است. این محصول را خریداری کرد.</p>
                                                      </div>
                                                   </div>
                                                </div>
                                             </div>
                                              ...
                                              <form action="#">
                                                 ...
                                                 <div class="tp-product-details-review-input-wrapper">
                                                    <div class="tp-product-details-review-input-box">
                                                       <div class="tp-product-details-review-input">
                                                          <textarea id="msg" name="msg" placeholder="نظر خود را اینجا بنویسید..."></textarea>
                                                       </div>
                                                       <div class="tp-product-details-review-input-title">
                                                          <label for="msg">نام شما</label>
                                                       </div>
                                                    </div>
                                                    <div class="tp-product-details-review-input-box">
                                                       <div class="tp-product-details-review-input">
                                                          <input name="name" id="name" type="text" placeholder="شهنواز سکیل">
                                                       </div>
                                                       <div class="tp-product-details-review-input-title">
                                                 ...
                                                 <div class="tp-product-details-review-suggetions mb-20">
                                                    <div class="tp-product-details-review-remeber">
                                                       ...
                                                       <label for="remeber">نام، ایمیل و وب‌سایت من را برای دفعه بعد که نظر می‌دهم در این مرورگر ذخیره کنید.</label>
                                                    </div>
                                                 </div>
                                                 <div class="tp-product-details-review-btn-wrapper">
                                                    <button class="tp-product-details-review-btn">ارسال</button>
                                                </div>
                                             </form>
                                          </div>
                                       </div>
            ...
            <div class="container">
               <div class="row">
                  <div class="tp-section-title-wrapper-6 text-center mb-40">
                     <span class="tp-section-title-pre-6">محصولات روز بعد</span>
                                 ...
                                 <div class="tp-product-content-3">
                                    <div class="tp-product-tag-3">
                                     ...
                                     <h3 class="tp-product-title-3">
                                        <a href="product-details.html">تبلت Android GalaxyS6</a>
                                     </h3>
                              ...
                              <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                 ...
                                 <div class="tp-product-content-3">
                                    <div class="tp-product-tag-3">
                                     ...
                                     <h3 class="tp-product-title-3">
                                        <a href="product-details.html">مایکروسافت سرفیس پرو</a>
                                     </h3>
                                     <div class="tp-product-price-wrapper-3">
                                        <span class="tp-product-price-3">240 تومان</span>
                                    </div>
                                 </div>
                              </div>
                           </div>
                              ...
                              <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                 <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                    ...
                                    <div class="tp-product-badge">
                                       <span class="product-hot">تازه</span>
                                    </div>
                                 ...
                                 <div class="tp-product-content-3">
                                    <div class="tp-product-tag-3">
                                       <span>ویدئو و دوربین</span>
                                     </div>
                                     <h3 class="tp-product-title-3">
                                        <a href="product-details.html">دوربین ویدیویی دیجیتال 4K.</a>
                                     </h3>
                                     <div class="tp-product-price-wrapper-3">
                                        <span class="tp-product-price-3 new-price">76 تومان</span>
                                        <span class="tp-product-price-3 old-price">106 تومان</span>
                                     </div>
                                 </div>
                              </div>
                           </div>
                           <div class="swiper-slide">
                              <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                 <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                    ...
                                    <!-- product badge -->
                                    <div class="tp-product-badge">
                                       <span class="product-trending">بهترین</span>
                                    </div>
                                 ...
                                 <div class="tp-product-content-3">
                                    <div class="tp-product-tag-3">
                                     ...
                                     <h3 class="tp-product-title-3">
                                        <a href="product-details.html">ساعت مراقبت از پوست را کشف کنید</a>
                                     </h3>
                                     <div class="tp-product-price-wrapper-3">
                                        <span class="tp-product-price-3">44 تومان</span>
                                    </div>
                                 </div>
                              </div>
                           </div>
