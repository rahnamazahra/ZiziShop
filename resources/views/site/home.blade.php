...
@section('content')
   <!-- slider area start -->
    <section class="tp-slider-area p-relative z-index-1">
        <div class="tp-slider-active-2 swiper-container">
            <div class="swiper-wrapper">
                <div class="tp-slider-item-2 tp-slider-height-2 p-relative swiper-slide grey-bg-5 d-flex align-items-end">
                    <div class="tp-slider-2-shape">
                        <img class="tp-slider-2-shape-1" src="{{ asset('site/assets/img/slider/2/shape/shape-1.png') }}" alt="">
                    </div>
                    <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            <div class="tp-slider-content-2">
                                <span>موارد جدید 2023</span>
                                <h3 class="tp-slider-title-2">مجموعه لباس</h3>
                                <div class="tp-slider-btn-2">
                                     <a href="shop.html" class="tp-btn tp-btn-border">خرید مجموعه</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            <div class="tp-slider-thumb-2-wrapper p-relative">
                                <div class="tp-slider-thumb-2-shape">
                                    <img class="tp-slider-thumb-2-shape-1" src="{{ asset('site/assets/img/slider/2/shape/shape-2.png') }}" alt="">
                                    <img class="tp-slider-thumb-2-shape-2" src="{{ asset('site/assets/img/slider/2/shape/shape-3.png') }}" alt="">
                                </div>
                                
                                <div class="tp-slider-thumb-2 text-start">
                                    <span class="tp-slider-thumb-2-gradient"></span>
                                    <img src="{{ asset('site/assets/img/slider/2/slider-1.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                ...
                <div class="tp-slider-item-2 tp-slider-height-2 p-relative swiper-slide grey-bg-5 d-flex align-items-end">
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            <div class="tp-slider-content-2">
                                <span>پرفروش‌ترین سال 2023</span>
                                <h3 class="tp-slider-title-2">مجموعه تابستانی</h3>
                                <div class="tp-slider-btn-2">
                                    <a href="shop.html" class="tp-btn tp-btn-border">خرید مجموعه</a>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            <div class="tp-slider-thumb-2-wrapper p-relative">
                                ...
                                <div class="tp-slider-thumb-2 text-start">
                                <span class="tp-slider-thumb-2-gradient"></span>
                                <img src="{{ asset('site/assets/img/slider/2/slider-2.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="tp-slider-item-2 tp-slider-height-2 p-relative swiper-slide grey-bg-5 d-flex align-items-end">
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            <div class="tp-slider-content-2">
                                <span>زمستان فرا رسید</span>
                                <h3 class="tp-slider-title-2">طرح های جدید شگفت انگیز</h3>
                                <div class="tp-slider-btn-2">
                                    <a href="shop.html" class="tp-btn tp-btn-border">خرید مجموعه</a>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            <div class="tp-slider-thumb-2-wrapper p-relative">
                                ...
                                <div class="tp-slider-thumb-2 text-start">
                                <span class="tp-slider-thumb-2-gradient"></span>
                                <img src="{{ asset('site/assets/img/slider/2/slider-3.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="tp-s`wiper-dot tp-slider-2-dot"></div>
        </div>
    </section>
    <!-- slider area end -->
         ...
         <div class="row">
            <div class="col-xl-12">
               <div class="tp-section-title-wrapper-2 text-center mb-35">
                  ...
                  <h3 class="tp-section-title-2">محصول سبک مورد علاقه مشتری</h3>
               </div>
            </div>
         </div>
         <div class="row">
                     ...
                     <div class="row">
                           ...
                           <div class="tp-product-item-2 mb-40">
                                 ...
                                 <div class="tp-product-action-2 tp-product-action-blackStyle">
                                    <div class="tp-product-action-item-2 d-flex flex-column">
                                       <button type="button" class="tp-product-action-btn-2 tp-product-add-cart-btn">
                                          ...
                                          <span class="tp-product-tooltip tp-product-tooltip-right">افزودن به سبد خرید</span>
                                       </button>
                                       ...
                                       <button type="button" class="tp-product-action-btn-2 tp-product-add-to-wishlist-btn">
                                          ...
                                          <span class="tp-product-tooltip tp-product-tooltip-right">اضافه به علاقمندی ها</span>
                                       </button>
                                       <button type="button" class="tp-product-action-btn-2 tp-product-add-to-compare-btn">
                                          ...
                                          <span class="tp-product-tooltip tp-product-tooltip-right">اضافه برای مقایسه</span>
                                       </button>
                                    </div>
                                 </div>
                              </div>
                              <div class="tp-product-content-2 pt-15">
                                 <div class="tp-product-tag-2">
                                    <a href="#">فروشگاه دم سفید</a>
                                 </div>
                                 <h3 class="tp-product-title-2">
                                    <a href="product-details.html">آسمان باز زنان دم سفید</a>
                                 </h3>
                                 ...
                                 <div class="tp-product-price-wrapper-2">
                                    <span class="tp-product-price-2 new-price">340.00 تومان</span>
                                    <span class="tp-product-price-2 old-price">475.00 تومان</span>
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                           <div class="tp-product-item-2 mb-40">
                              <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                 <a href="product-details.html">
                                    <img src="{{('site/assets/img/product/2/prodcut-2.jpg') }}"alt="">
                                 </a>
                                 <!-- product action -->
                                 <div class="tp-product-action-2 tp-product-action-blackStyle">
                                    <div class="tp-product-action-item-2 d-flex flex-column">
                              ...
                              <div class="tp-product-content-2 pt-15">
                                 ...
                                 <h3 class="tp-product-title-2">
                                    <a href="product-details.html">پسران ساده و مدرن مدرسه</a>
                                 </h3>
                                 <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                    <span><i class="fa-solid fa-star"></i></span>
                                    <span><i class="fa-solid fa-star"></i></span>
                                 ...
                                 <div class="tp-product-price-wrapper-2">
                                    <span class="tp-product-price-2 new-price">102.00 تومان</span>
                                    <span class="tp-product-price-2 old-price">119.00 تومان</span>
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                           <div class="tp-product-item-2 mb-40">
                              <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                 <a href="product-details.html">
                                    <img src="{{('site/assets/img/product/2/prodcut-3.jpg') }}"alt="">
                                 </a>
                                 <!-- product action -->
                                 <div class="tp-product-action-2 tp-product-action-blackStyle">
                                    <div class="tp-product-action-item-2 d-flex flex-column">
                              ...
                              <div class="tp-product-content-2 pt-15">
                                 ...
                                 <h3 class="tp-product-title-2">
                                    <a href="product-details.html">مواد ضروری زنانه قابل تبدیل</a>
                                 </h3>
                                 <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                    <span><i class="fa-solid fa-star"></i></span>
                                    <span><i class="fa-solid fa-star"></i></span>
                                 ...
                                 <div class="tp-product-price-wrapper-2">
                                    <span class="tp-product-price-2">45.00 تومان</span>
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                           <div class="tp-product-item-2 mb-40">
                              <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                 <a href="product-details.html">
                                    <img src="{{('site/assets/img/product/2/prodcut-4.jpg') }}"alt="">
                                 </a>
                                 <!-- product action -->
                                 <div class="tp-product-action-2 tp-product-action-blackStyle">
                                    <div class="tp-product-action-item-2 d-flex flex-column">
                              ...
                              <div class="tp-product-content-2 pt-15">
                                 ...
                                 <h3 class="tp-product-title-2">
                                    <a href="product-details.html">تازه کالوین کلاین گابریانا</a>
                                 </h3>
                                 <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                    <span><i class="fa-solid fa-star"></i></span>
                                    <span><i class="fa-solid fa-star"></i></span>
                                 ...
                                 <div class="tp-product-price-wrapper-2">
                                    <span class="tp-product-price-2 new-price">245.00 تومان</span>
                                    <span class="tp-product-price-2 old-price">120.00 تومان</span>
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                           <div class="tp-product-item-2 mb-40">
                              <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                 <a href="product-details.html">
                                    <img src="{{('site/assets/img/product/2/prodcut-5.jpg') }}"alt="">
                                 </a>
                                 <!-- product action -->
                                 <div class="tp-product-action-2 tp-product-action-blackStyle">
                                    <div class="tp-product-action-item-2 d-flex flex-column">
                              ...
                              <div class="tp-product-content-2 pt-15">
                                 ...
                                 <h3 class="tp-product-title-2">
                                    <a href="product-details.html">جیدن زنانه تامی هیلفیگر</a>
                                 </h3>
                                 <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                    <span><i class="fa-solid fa-star"></i></span>
                                    <span><i class="fa-solid fa-star"></i></span>
                                 ...
                                 <div class="tp-product-price-wrapper-2">
                                    <span class="tp-product-price-2">40.00 تومان</span>
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                           <div class="tp-product-item-2 mb-40">
                              <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                 <a href="product-details.html">
                                    <img src="{{('site/assets/img/product/2/prodcut-6.jpg') }}"alt="">
                                 </a>
                                 <!-- product action -->
                                 <div class="tp-product-action-2 tp-product-action-blackStyle">
                                    <div class="tp-product-action-item-2 d-flex flex-column">
                              ...
                              <div class="tp-product-content-2 pt-15">
                                 ...
                                 <h3 class="tp-product-title-2">
                                    <a href="product-details.html">چرم کفش مردانه گوویتا</a>
                                 </h3>
                                 <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                    <span><i class="fa-solid fa-star"></i></span>
                                    <span><i class="fa-solid fa-star"></i></span>
                                 ...
                                 <div class="tp-product-price-wrapper-2">
                                    <span class="tp-product-price-2 new-price">75.00 تومان</span>
                                    <span class="tp-product-price-2 old-price">79.00 تومان</span>
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                           <div class="tp-product-item-2 mb-40">
                              <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                 <a href="product-details.html">
                                    <img src="{{('site/assets/img/product/2/prodcut-7.jpg') }}"alt="">
                                 </a>
                                 <!-- product action -->
                                 <div class="tp-product-action-2 tp-product-action-blackStyle">
                                    <div class="tp-product-action-item-2 d-flex flex-column">
                              ...
                              <div class="tp-product-content-2 pt-15">
                                 ...
                                 <h3 class="tp-product-title-2">
                                    <a href="product-details.html">مردانه دم سفید افسانه ای.</a>
                                 </h3>
                                 <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                    <span><i class="fa-solid fa-star"></i></span>
                                    <span><i class="fa-solid fa-star"></i></span>
                                 ...
                                 <div class="tp-product-price-wrapper-2">
                                    <span class="tp-product-price-2">38.00 تومان</span>
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                           <div class="tp-product-item-2 mb-40">
                              <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                 <a href="product-details.html">
                                    <img src="{{('site/assets/img/product/2/prodcut-8.jpg') }}"alt="">
                                 </a>
                                 <!-- product action -->
                                 <div class="tp-product-action-2 tp-product-action-blackStyle">
                                    <div class="tp-product-action-item-2 d-flex flex-column">
                              ...
                              <div class="tp-product-content-2 pt-15">
                                 ...
                                 <h3 class="tp-product-title-2">
                                    <a href="product-details.html">کوله پشتی، کیف مدرسه.</a>
                                 </h3>
                                 <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                    <span><i class="fa-solid fa-star"></i></span>
                                    <span><i class="fa-solid fa-star"></i></span>
                                 ...
                                 <div class="tp-product-price-wrapper-2">
                                    <span class="tp-product-price-2">105.00 تومان</span>
                                 </div>
                              </div>
                           </div>
                        </div>
   ...
   <!-- product area end -->
    ...
    <div class="container">
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="tp-product-item-2 mb-40">
                        <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                        <a href="product-details.html">
                            <img src="{{('site/assets/img/product/2/prodcut-9.jpg') }}"alt="">
                        </a>
                        <!-- product action -->
                        <div class="tp-product-action-2 tp-product-action-blackStyle">
                            <div class="tp-product-action-item-2 d-flex flex-column">
                        ...
                        <div class="tp-product-price-wrapper-2">
                            <span class="tp-product-price-2 new-price">76.00 تومان</span>
                            <span class="tp-product-price-2 old-price">120.00 تومان</span>
                        </div>
                        </div>
                    </div>
        ...
        @empty
            <div class="col-xl-3 col-lg-4 col-sm-6">هیچ آیتمی ثبت نشده است</div>
        @endforelse  --}}
        ...
        <div class="modal-content">
            <div class="tp-product-modal-content d-lg-flex align-items-start">
                ...
                <div class="tp-product-details-category">
                    ...
                    <h3 class="to-product-details-title">لباس زنانه قهوه ای</h3>
                <!-- inventory details -->
                ...
                <div class="tp-product-details-price-wrapper mb-20">
                    <span class="tp-product-details-price old-price">320 هزار</span>
                    <span class="tp-product-details-price new-price">220 هزار</span>
                </div>
                ...
                <div class="tp-product-details-variation">
                    ...
                    <div class="tp-product-details-variation-item">
                        ...
                        <div class="tp-product-details-variation-list">
                            ...
                            <span class="tp-color-variation-tootltip">مشکی</span>
                            </button>
                            <button type="button" class="color tp-color-variation-btn" >
