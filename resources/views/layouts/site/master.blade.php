...
<body>
    <section class="p-5">
        <div class="flex justify-between gap-6">
            ...
            <div class="w-[30rem]">
                <form method="GET">
                    <div class="flex justify-between bg-color2 rounded-md p-2">
                        <div class="w-3/4 mr-10 relative text-gray-600 focus-within:text-gray-400">
                            ...
                            <input type="search" name="search" class="w-full py-2 text-sm text-white bg-color2 rounded-md pl-2 border-none" placeholder="جست‌و‌جو" autocomplete="off">
                        </div>
                    </div>
                </form>
