...
@section('breadcrumb')
    <x-panel.breadcrumb :breadcrumb="['داشبورد' => route('admin.dashboard'), 'کوپن' => route('admin.vouchers.index'), 'ویرایش کوپن' => route('admin.vouchers.edit', ['voucher' => $voucher])]" title='کاربران' />
@endsection

@section('content')
    <form method="POST" action="{{ route('admin.vouchers.update', ['voucher' => $voucher]) }}">
        @csrf
        @method("PATCH")
            ...
            <x-panel.card-body>
                <x-panel.row>
                    <x-panel.div-section class="col-md-6">
                        ...
                        <x-form.input type="text" name="code" value="{{ old('code', $voucher->code) }}"/>
                        <x-form.input-error :messages="$errors->get('code')" class="mt-2" />
                    </x-panel.div-section>

                    <x-panel.div-section class="col-md-6">
                        <x-form.label id="discount" class="">میزان تخفیف</x-form.label>
                        <x-form.input type="discount" name="discount" value="{{ old('discount', $voucher->discount) }}"/>
                        <x-form.input-error :messages="$errors->get('discount')" class="mt-2" />
                    </x-panel.div-section>

                    <x-panel.div-section class="col-md-6">
                        <x-form.label id="start_date" class="">تاریخ شروع تخفیف</x-form.label>
                        <x-form.input type="start_date" id="input_date" name="start_date" value="{{ old('start_date', $voucher->start_date) }}" data-jdp/>
                    ...
                    <x-panel.div-section class="col-md-6">
                        ...
                        <x-form.input type="end_date" id="input_date" name="end_date" value="{{ old('end_date', $voucher->end_date) }}" data-jdp/>
                        <span id="calendar"></span>
                    ...
                    <x-panel.div-section class="col-md-6">
                        ...
                        <x-form.input type="shipping_discount" name="shipping_discount" value="{{ old('shipping_discount', $voucher->shipping_discount) }}"/>
                    ...
                    <x-panel.div-section class="col-md-6">
                        ...
                        <x-form.input type="mininum_purchase_total" name="mininum_purchase_total" value="{{ old('mininum_purchase_total', $voucher->mininum_purchase_total) }}"/>
                    ...
                    <x-panel.div-section class="col-md-6">
                        ...
                        <x-form.input type="maximum_discount" name="maximum_discount" value="{{ old('maximum_discount', $voucher->maximum_discount) }}"/>
                    ...
                    <x-panel.div-section class="col-md-6">
                        ...
                        <x-form.input type="maximum_shipping_discount" name="maximum_shipping_discount" value="{{ old('maximum_shipping_discount', $voucher->maximum_shipping_discount) }}"/>
                    ...
                    <x-panel.div-section class="col-md-6">
                        ...
                        <x-form.input type="remaining" name="remaining" value="{{ old('remaining', $voucher->remaining) }}"/>
                        <x-form.input-error :messages="$errors->get('remaining')" class="mt-2" />
                    </x-panel.div-section>

                    <x-panel.div-section class="col-md-6">
                        <x-form.label id="comment" class="">توضیحات</x-form.label>
                        <x-form.input type="comment" name="comment" value="{{ old('comment', $voucher->comment) }}"/>
