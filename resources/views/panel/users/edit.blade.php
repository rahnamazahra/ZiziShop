...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
        ...
        <li class="breadcrumb-item text-muted">
            <a href="{{ route('admin.users.index') }}" class="text-muted text-hover-primary">محصولات</a>
        </li>
        <li class="breadcrumb-item">
            <span class="bullet bg-gray-300 w-5px h-2px"></span>
        </li>
    ...
    <div class="card shadow-sm">
        <form method="POST" action="{{ route('admin.users.update', ['user' => $user->id]) }}">
            ...
            <div class="card-header">
                <div class="card-title">ویرایش کابر {{ $user->name }}</div>
            </div>
            <div class="card-body">
                <div class="row g-9">
                    <div class="col-md-6 fv-row">
                        <label for="name" class="required form-label">نام</label>
                        <input type="text" class="form-control form-control-solid" name="name" value="{{ old('name', $user->name) }}" />
                    </div>
                </div>
                <div class="col-md-6 fv-row">
            ...
            <div class="card-footer">
                <div class="d-flex justify-content-end">
                    ...
                    <button type="submit" id="add_user_form_submit" class="btn btn-primary">
