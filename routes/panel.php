...
use App\Http\Controllers\Panel\{UserController, ProductController, CategoryController, DashboardController};
...
Route::controller(CategoryController::class)->name('admin.')->group(function () {
    Route::put('/categories/{categoryd}/restore', 'restore')->name('categories.restore');
    Route::post('/categories/{category}/force-delete', 'forceDelete')->name('categories.force-delete');
...
Route::controller(ProductController::class)->name('admin.')->group(function (){
    ...
    Route::post('/products/{product}/force-delete', 'forceDelete')->name('products.force-delete');
